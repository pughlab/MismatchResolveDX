...
sub main {
	...
	my $report_stem =  "multiMMR_report__" . $args{id} . ".tex";
	...
	my @filtered_files = grep { $_ ne $report_stem } @tex_files;

	# initiate report file
	open(my $report_file, '>', $args{patient_dir} . "/" . $report_stem); 
...
#	print $report_file "\\input{methods.tex}\n";
	...
	print $report_file "{\\scriptsize \\path{$args{patient_dir}/$report_stem}}\n\n";
...
# declare variables
my ($help, $output_directory, $patient_id);
